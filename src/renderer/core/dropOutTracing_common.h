...
namespace dropOut_tracing
{
    ...
    const float light_subpath_caustic_discard_ratio = DOT_MORE_PROXY_LIGHT_SUBPATH_NUM?0.5f:0.95f;
...
#define DOT_VERY_CLOSE_DISTANCE2 0.04f
...
#define DOT_INVALID_SPECULARID 0
    ...
    struct dropOutTracing_params
    {
        ...
        RT_FUNCTION int get_surface_label(float3 position, float3 normal,float3 dir = make_float3(0.0f))
